        ...
        <nav className="p-2 bg-white bg-opacity-90 w-full">
            <div className="mx-5 flex justify-between items-center">
                ...
                <button
                    ...
                    className="shadow-lg w-40 h-10 hover:shadow-xl transition-shadow duration-300 bg-purple-900 text-xs md:text-sm lg:text-md text-white py-2 px-6 rounded-full"
                >
                    Login
                </button>
            </div>
