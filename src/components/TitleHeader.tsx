...
export default function TitleHeader({ title, className }: TitleHeaderProps) {
    ...
    return (
        <div className={`${className} mx-[1rem] mt-4 max-h-[100vh] mb-[1rem]`}>
            <div className="h-[64px] top-0 left-0">
                <div
                    className={`relative mx-auto min-h-[64px] bg-[#2684ff] lg:rounded-[24px] ${isNavOpen ? "rounded-tr-3xl rounded-tl-3xl" : "rounded-[24px]"}`}
                >
